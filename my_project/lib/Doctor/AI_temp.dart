...
class _AiSymptomCheckerScreenState extends State<AiSymptomCheckerScreen> {
  ...
  // Session-based history: each element is a List<Map> (one conversation)
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          // ✅ Profile icon REMOVED per user request
        ],
      ),
    );
  }
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text(
            'Ask medical questions, drug info, diagnoses, or treatment guidance.',
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          // Mic button — green when listening
          GestureDetector(
